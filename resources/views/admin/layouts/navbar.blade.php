    ...
    <nav class="navbar-custom">
        ...
        <ul class="float-right mb-0 list-inline">
            ...
            <li class="list-inline-item dropdown notification-list hide-phone">
                <a class="text-white nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button"
            ...
            <li class="list-inline-item dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                    ...
                    <div class="dropdown-item noti-title">
                        <h5><span class="float-right badge badge-danger">745</span>Messages</h5>
                    </div>
            ...
            <li class="list-inline-item dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <a class="dropdown-item" href="#"><span class="float-right badge badge-success">5</span><i class="mdi mdi-settings m-r-5 text-muted"></i> Settings</a>
